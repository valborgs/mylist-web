...
urlpatterns = [
    ...
    path('production_list/', production_list, name='production_list'),
    path('production_list/<production_slug>', prodution_detail, name='production_detail'),
    path('genre_list/', genre_list, name='genre_list'),
    path('genre_list/<genre_slug>', genre_detail, name='genre_detail'),
    path('year_list/', year_list, name='year_list'),
    path('year_list/<year_slug>', year_detail, name='year_detail'),
]
